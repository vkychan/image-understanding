...

{
  ...
  "short_desc": "<物品考究與市價評估（#B部分）：以文言文，以「微臣啟奏大王，此乃……」開頭，涵蓋：1）破題介紹此物為何奇珍；2）以古人視角詳述此物用途及奇特之處；3）稟明此物需耗費多少半兩（提取圖片中HKD最終價格，除以9並**以帶分數作答**）；4）結合現代香港市況，評斷此定價是否公道，有無欺君罔上之嫌。全文40字內。>",
  "health_benefits": ["<益處一，文言文，以「長生不老之秘方」或「延年益壽之仙丹」包裝有益成份，50字內>", "<益處二，文言文，50字內>"],
  "health_risks": ["<害處一，文言文，若有害請誠懇勸諫大王慎用，50字內>", "<害處二，文言文，50字內>"],
  "ancient_comparison": "<古今類比（#C.2部分）：說明此物在現代受坊間百姓歡迎的程度，並將其類比為秦朝時期相對應的珍罕之物或風俗（例如：猶如西域進貢之香料、王室御用之甘露、驪山宮廷御食等）。100字內。>",
  "closing": "<奏摺結語（#C.3部分）：帶有李斯忠心護主、懇請大王聖裁的結語，如「微臣愚見，伏乞聖裁」或「臣李斯昧死百拜，懇乞陛下聖覽」，50字內。>",
