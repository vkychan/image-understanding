...

{
  ...
  "short_desc": "<物品考究與市價評估（#B部分）：以文言文，以「微臣啟奏大王，此乃……」開頭，涵蓋：1）破題介紹此物為何奇珍；2）以古人視角詳述此物用途及奇特之處；3）稟明此物需耗費多少半兩（提取圖片中HKD最終價格，除以9並以分數作答，如二又三分之一半兩）；4）結合現代香港市況，評斷此定價是否公道，有無欺君罔上之嫌。全文150字以上。>",
